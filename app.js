...
entradaDados.question('Qual é o seu nome?: ', function(nomeAluno){

    let aluno = nomeAluno

    entradaDados.question('Qual é o nome do seu professor?: ', function(nomeProfessor){

        let professor = nomeProfessor

        entradaDados.question('Qual é o seu sexo? (M/F): ', function(sexoAluno){

            let sexoA = sexoAluno.ignorecase

            entradaDados.question('Qual é o sexo do seu professor? (M/F) ', function(sexoProfessor){
                                    ...
                                    entradaDados.question('Digite sua nota 4: ', function(nota4Aluno){
                                        ...
                                        if (resultadoStatus[0] >=50 && resultadoStatus[0] <= 69) {
                                            entradaDados.question('Você ficou em exame!!! Qual foi a nota que tirou?: ', function (notaExame){
                                                ...
                                                if ( notaFinal< 60) {
                                                    console.log( `Você foi reprovado. Sua nota final foi de: ${notaFinal}`)
                                                } else {
                                                    console.log(`Você foi aprovado. Sua nota final foi de: ${notaFinal}`)
                                                }
